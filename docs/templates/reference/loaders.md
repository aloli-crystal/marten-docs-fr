...
**Classe** : [`Marten::Template::Loader::FileSystem`](https://martenframework.com/docs/api/dev/Marten/Template/Loader/FileSystem.html)
...
**Classe** : [`Marten::Template::Loader::AppDirs`](https://martenframework.com/docs/api/dev/Marten/Template/Loader/AppDirs.html)
...
**Classe** : [`Marten::Template::Loader::Cached`](https://martenframework.com/docs/api/dev/Marten/Template/Loader/Cached.html)
